...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.txt_giorni = ft.TextField(label="Giorni")


        # button for the "creat graph" reply
        self.btn_graph = ft.ElevatedButton(text="Crea Grafo", on_click=self._controller.handle_graph)
        row1 = ft.Row([self.ddyear,self.txt_giorni, self.btn_graph],
        ...
        self.btn_path = ft.ElevatedButton(text="Simula", on_click=self._controller.handle_search)
